...
- The Shopping sequence starts once 70% of its scene is visible. It shows fifth position, reveals the intervention after 1.1 seconds, then moves the product to first at 3.2 seconds, easing over 850 ms. The intervention remains written in the final state. No pinned scrolling, infinite drift or scroll lock. Replay is explicit.
