        ...
        <div className="mt-14 grid items-start gap-12 xl:grid-cols-[320px_minmax(0,1fr)]">
          ...
          >
            {TABS.map((tab, i) => {
              ...
              return (
                <div key={tab.id} className="border-b border-line last:border-b-0">
                  <button
                    ref={(el) => {
                    ...
                    onClick={() => select(i)}
                    className={`w-full py-4 text-left text-[20px] font-medium tracking-[-0.02em] transition-colors ${
                  ...
                  {selected && (
                    <div className="pb-4">
                      ...
                      {/* Progress bar — fills while auto-advancing, static once the
                          user has taken over. */}
          ...
          <div
            ...
            tabIndex={0}
            className="relative aspect-[880/648] w-full overflow-hidden rounded-[20px]"
          >
            <Photo
            ...
            <div className="relative grid h-full place-items-center p-10 lg:p-12">
